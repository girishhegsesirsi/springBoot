...
import com.sb.service.GroupUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    	System.out.println(" in configure() with AuthenticationManagerBuilder auth="+auth.toString());
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	System.out.println(" in configure() with HttpSecurity http="+http.toString());
        http.csrf().disable();
